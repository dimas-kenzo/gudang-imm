...
@section('content')
    <div class="card">
        <div class="card-datatable table-responsive pt-0">
            <h1 class="mt-3 px-2">List Bahan -> Grade 1<a href="{{ route('warehouse.create') }}" class="btn btn-success float-end"><i class="mdi mdi-plus me-2"></i>Create Bahan</a></h1>
    ...
    <div class="card">
        <div class="card-datatable table-responsive pt-0">
            <h1 class="mt-3 px-2">List Bahan -> Grade 2<a href="{{ route('warehouse.create') }}" class="btn btn-success float-end"><i class="mdi mdi-plus me-2"></i>Create Bahan</a></h1>
    ...
    <div class="card">
        <div class="card-datatable table-responsive pt-0">
            <h1 class="mt-3 px-2">List Bahan -> Grade 3<a href="{{ route('warehouse.create') }}" class="btn btn-success float-end"><i class="mdi mdi-plus me-2"></i>Create Bahan</a></h1>
